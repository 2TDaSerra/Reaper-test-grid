...
- Nível `0` enquadrado entre `1.1.000` e `41.1.000`, com compensação da barra
  interna e margem final medida de 27 px.
- Níveis `1` a `23` calibrados pela escala fixa de 1392 px registrada nas
  capturas do ACID, preservando o mesmo espaçamento ao redimensionar o arrange.
...
- Em cada novo nível, o ponto da timeline sob o mouse é levado ao centro da
  tela, como no ACID; ao voltar ao nível `0`, a tela retorna a `1.1.000`.
